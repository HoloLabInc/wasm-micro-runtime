...
WASM_API_EXTERN uint8_t wasm_index_of_func_export(wasm_instance_t *inst, const char *name, uint32_t *out_index);
...
WASM_API_EXTERN uint8_t wasm_count_of_func_import(wasm_module_t *module, uint32_t *out_count);
